    ...
    <el-row :gutter="20" class="column-wrapper">
      ...
      <el-col :span="6" class="column">
        <div class="custom-card">
          ...
          <div class="custom-card-body">
            <el-table :data="annotationInfoList" :row-class-name="tableClassName" @cell-click="handelTableCellClick"
        ...
        <div class="custom-card pdf-card">
          <div class="custom-card-header">
            ...
            <div class="pdf-annotation-create">
              <span>点赞</span>
              <el-button :type="buttonsTypeName.pdf_like" @click="handleLikePdf" :loading="buttonsLoading.pdf_like"
              ...
              <div class="button-row">
                <el-button type="primary" plain @click="handleCreatePdfAnnotation"><b>PDF</b></el-button>
                <el-button type="success" plain @click="handleCreateMarkdownAnnotation"><b>Markdown</b></el-button>
              </div>
            </div>
          </div>
      ...
      <el-col :span="9" class="column">
        <div class="custom-card pdf-card">
          ...
          <div v-if="isCreateAnnotation" style="display: flex; flex-direction: column; flex-grow: 1; overflow: hidden;">
            <div class="pdf-info-bar">
              <span class="info-item" v-if="pdfInfo.course_name">
                <el-icon>
                  <CollectionTag />
            ...
            <div v-if="createAnnotationType == 'markdown'" class="create-annotation-form"
              ...
              <div class="form-item" style="display: flex; flex-direction: column; flex-grow: 1;">
                ...
                <el-input v-model="newAnnotation.content" type="textarea" placeholder="在此输入 Markdown 内容..."
                  resize="none" style="height: 100%;" input-style="height: 100%;" />
              </div>
            </div>
